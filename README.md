# !ПРОЕКТ БЕЗ /media/ тк гит не хочет вливать столкьо файлов, а клонировать репозиторий и сделать коммит через баш не получается из за проблем с авторизацией.
